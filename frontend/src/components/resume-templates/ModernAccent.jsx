...
export default function ModernAccent({ resume }) {
  ...
  return (
    <div className="font-sans text-slate-800 bg-white shadow-xl mx-auto flex overflow-hidden min-h-[1056px] w-[816px] text-[13px] leading-relaxed">
      ...
      {/* Left Sidebar */}
      <aside className="w-[35%] bg-slate-50 border-r border-slate-200 p-8 flex flex-col gap-6">
        
        {resume.photo && (
          <div className="flex justify-center mb-2">
            <img src={resume.photo} alt="Profile" className="w-32 h-32 object-cover rounded-full border-4 border-white shadow-md" />
          </div>
        )}
